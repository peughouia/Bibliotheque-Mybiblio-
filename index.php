          ...
          <div class="logo">
            My<span class="log">Biblio</span>
                ...
                <ul class="list-item">
                    ...
                    <li class="item"><a href="#apropos">Contacts</a></li>
                    <li class="item"><a href="http://localhost/bibliotheque/Inscription/inscription.php">Inscription</a></li>
                </ul>
        </nav>
        <div  id="accueil"></div>
        <section class="container-home">
            <div class="text-content">
                <div class="text-item">
                    ...
                    <form action="http://localhost/bibliotheque/connexion/connexion.php">
